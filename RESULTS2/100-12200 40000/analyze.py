...
if __name__ == "__main__":
    nF = np.loadtxt('./data_nF_i_40000.txt')
    nB = np.loadtxt('./data_nB_i_40000.txt')
    pF = np.loadtxt('./data_pF_i_40000.txt')
    pB = np.loadtxt('./data_pB_i_40000.txt')
    ...
    plot_b(eta, b_pp, x_fun, y_fun_pp, 0.2, 'b_pp(eta)', pp_formula)
